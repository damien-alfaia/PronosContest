...
- [x] **Sprint 6** — Social & gamification (badges ✅, chat ✅, notifs ✅) — *branche `feat/sprint-6-social`*
- [x] **Sprint 7** — PWA, perf, docs *(en cours sur `feat/sprint-7-pwa-perf-docs`)* + (optionnel, reporté) import auto API-Football

Sprint courant : **Sprint 7** (PWA ✅, perf ✅, docs ✅, lancement à venir).
